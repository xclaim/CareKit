...
@class SLKTextInputbar, SLKTypingIndicatorView, SLKTextView, OCKConnectViewController;
@protocol SLKTextViewDelegate, SLKTypingIndicatorProtocol, OCKConnectViewControllerDataSource, OCKConnectViewControllerDelegate;
...
NS_CLASS_AVAILABLE_IOS(7_0) @interface SLKTextViewController : UIViewController <SLKTextViewDelegate,
                                                                                UITableViewDelegate,
...
@interface OCKSlackMessagesViewController: SLKTextViewController
